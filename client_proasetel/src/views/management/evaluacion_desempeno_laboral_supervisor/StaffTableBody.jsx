            ...
            <TableRow hover role="checkbox" aria-checked={isItemSelected} tabIndex={-1} selected={isItemSelected}>
                ...
                <TableCell align="center" sx={{ pr: 3, ...(open && { display: 'none'})}}>
                    <Stack direction="row" alignItems="center" spacing={1} justifyContent="center">
                        <Button onClick={() => navigate(`/management/evaluacion_desempeno_laboral_supervisor/evaluacion_list_obj/evaluacion_desempeno_laboral/${row.id}`)}>
                        {/* <Button onClick={() => navigate(`../views/pages/maintenance/UnderConstruction`)}> */}
                            Evaluar
                        </Button>
                    </Stack>
                </TableCell>
