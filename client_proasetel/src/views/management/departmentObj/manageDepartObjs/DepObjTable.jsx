...
// project imports
import DepObjTableHeader from './DepObjTableHeader'
...
import { removeObjDep} from 'store/slices/departmentobj';
...
const DepObjTable = ({ open, setOpen, listDepObj, setRowValue, objEmpDep }) => {
    ...
    const handleBusinessObjDelete = async () => {
        ...
        const data = {
            id: rowToDelete.idObjDep,
            objtivoEmpDep: objEmpDep.objEmpDepId
        }

        console.log('Data para la eliminación:', data)
        
        const result = await dispatch(removeObjDep(data));
