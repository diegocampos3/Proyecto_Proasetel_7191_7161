...
const AddDepObj = () => {
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, {  setSubmitting }) => {
            try {
                ...
                const result = await dispatch(addObjDep(data));
    ...
    return (
        <MainCard
            title="Crear Objetivo Departamental"
        >
            <form onSubmit={handleSubmit}>
                <Grid container spacing={gridSpacing}>
                    ...
                    <Grid item xs={12} container justifyContent="flex-end" spacing={2}>
                        <Grid item>
                            <Button variant="outlined" color="secondary" onClick={() => navigate('/management/departmentobj/manageDepartObj', 
                            {
                                state: {objEmpDep}
                            })}>
                                Cancelar
