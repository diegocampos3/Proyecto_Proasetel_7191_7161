...
const BusinessObjTableHeader = ({ drawer, onSelectAllClick, order, orderBy, numSelected, rowCount, onRequestSort, selected }) => {
...
BusinessObjTableHeader.propTypes = {
...
export default BusinessObjTableHeader;
