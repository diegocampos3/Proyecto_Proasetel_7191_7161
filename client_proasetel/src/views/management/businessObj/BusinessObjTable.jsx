...
import BusinessObjTableHeader from './BusinessObjTableHeader'
...
import { removeBusinessObj} from 'store/slices/businessobj';
...
const BusinessObjTable = ({ open, setOpen, listBusinessObj, setRowValue }) => {
    ...
    const handleBusinessObjDelete = async () => {
        ...
        const result = await dispatch(removeBusinessObj(rowToDelete.id));
    ...
    const handleEditClick = (row) => {
        navigate('/management/businessobj/editbusinessobj', {
            state: { objetivo: row },
        });
    };
...
BusinessObjTable.propTypes = {
    open: PropTypes.bool,
    setOpen: PropTypes.func,
    setRowValue: PropTypes.func,
    listBusinessObj: PropTypes.array
};

export default BusinessObjTable;
